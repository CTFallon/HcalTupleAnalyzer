...
LIBS= ${ROOTLIBS} 
SRC= ./src
BASE_OBJECTS=$(SRC)/analysisClass.o $(SRC)/baseClass.o $(SRC)/Object.o $(SRC)/Collection.o $(SRC)/Cell.o $(SRC)/RBXMap.o
PHYS_OBJECTS=$(SRC)/HcalDigi.o $(SRC)/HcalDigiIDs.o $(SRC)/HcalSample.o $(SRC)/HBHEDigi.o $(SRC)/HBHESample.o $(SRC)/HFDigi.o $(SRC)/QIE11Digi.o $(SRC)/QIE10Digi.o
